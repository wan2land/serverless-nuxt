...
> The `aws-serverless-express` package has been deprecated and @vendia/serverless-express is recommended.
> `serverless-nuxt` was also reworked accordingly and renamed to `nuxt-aws-lambda`.
